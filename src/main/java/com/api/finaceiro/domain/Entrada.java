...
public class Entrada implements Serializable {
	...
	@Length(min = 3, max = 100, message = "O valor nome deve ter emtre 3 e 100 caracteres")
	...
	@Length(min = 3, max = 20, message = "O campo descriçao deve ter emtre 3 e 20 caracteres")
	...
	public Entrada(Integer id, String valor, String data, String descricao, String tipo, String status, Usuario usuario,
			Mes mes) {
		super();
		this.id = id;
		this.valor = valor;
